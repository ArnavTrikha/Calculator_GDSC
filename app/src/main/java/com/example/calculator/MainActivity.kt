...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var PrevInput:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        PrevInput=findViewById(R.id.previnput)
    ...
    fun equaloperator(view:View){
        ...
        PrevInput.setText("$oldNum $operator $newNum")
    }
    ...
    fun get_backSpace(view: View){
        val length = inputbox.length()
        if(length>0){
            inputbox.text = inputbox.text.substring(0,length-1)
        }
    }
